        ...
        <ul class="links">
          <li>
            ...
            <ul class="htmlCss-sub-menu sub-menu">
              ...
              <li><a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/Cargar_Excel/Calificaciones.php">Registro Calificaciones Parciales</a></li>
         ...
         <li>
            ...
            <ul class="js-sub-menu sub-menu">
              <li><a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/Cargar_Excel/Maestros.php">Registro Archivo</a></li>
              <li><a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/menu_AD/Consultas/Docente_index.php">CRUD</a></li>
         ...
         <li>
          ...
          <li>
            ...
            <i class='bx bxs-chevron-down js-arrow arrow '></i>
            <ul class="js-sub-menu sub-menu">
              <li><a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/Cargar_Excel/Mat_Maestro.php">Registro Archivo</a></li>
          ...
          <li ><a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/menu_AD/Consultas/Carreras.php">Carreras</a></li>
        </ul>
      </div>
      <div class="close">
        <a href="http://localhost:8080/SIIE(CBTIS)%20-%20V1.2/Inicios/MENU_ADMI/Archivos/menu_AD/Consultas/cerrrar_seson.php"><i class='bx bx-window-close' miatooltip="Texto"></i></a>
      </div>
    </div>
  </nav>
</header>